...
<h3 class="text-primary">Completed Laundries</h3> </div>
<div class="col-md-7 align-self-center">
<ol class="breadcrumb">
<li class="breadcrumb-item"><a href="index.php">Home</a></li>
<li class="breadcrumb-item active">Reports</li>
<li class="breadcrumb-item active">Completed Laundries</li>
</ol>
</div>
</div>
<!-- End Bread crumb -->
...
<a><button class="btn btn-primary" onclick="window.print();">Print</button></a>
<li><br></li>



<div class="table-responsive m-t-40  print-container">
