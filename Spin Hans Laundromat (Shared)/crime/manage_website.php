                                ...
                                <div class="input-states">
                                    <form class="form-horizontal" method="POST" enctype="multipart/form-data">
                                         ...
                                         <div class="form-group">
                                            <div class="row">
                                                <label class="col-sm-3 control-label">Dashboard Name</label>
                                                <div class="col-sm-9">
                                         ...
                                         <div class="form-group">
                                            <div class="row">
                                                <label class="col-sm-3 control-label">Marquee Title</label>
                                                <div class="col-sm-9">
                                   ...
                                   <!--     <div class="form-group">
                                          <div class="row">
                                           <label class="col-sm-3 control-label">Footer</label>
                                            <div class="col-sm-9">
                                        <input type="text" name="footer" rows="5" placeholder="Enter text ..." style="height:300px;"><?php echo $footer;?>
                                      </div>
                                        </div>
                                    </div> -->
